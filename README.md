...
| Field | Value |
| --- | --- |
| **Name** | `hermes-desktop-plugins-skill` |
...
cp -r hermes-desktop-plugins ~/.hermes/skills/hermes-desktop-plugins/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/hermes-desktop-plugins-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/hermes-desktop-plugins-skill.git ~/.hermes/skills/hermes-desktop-plugins/
```
...
```text
Use the hermes desktop plugins skill to <describe your specific task here>
```
...
```text
Gunakan skill hermes desktop plugins untuk <deskripsikan tugas spesifik Anda di sini>
```
